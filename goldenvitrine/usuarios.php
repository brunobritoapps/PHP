...
<head>
    ...
    <title>GOLDEN VITRINE | USUÁRIOS</title>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <td class="login"><?php echo $dados["login"]; ?></td>
                    <td class="email"><?php echo $dados["email"]; ?></td>
                    <td class="perfil"><?php echo $dados["perfil"]; ?></td>
					<td class="depto"><?php echo $dados["depto"]; ?></td>
                    <td>
                        <div id="modal">
                        <button type="button" class="btn btn-secondary mb-1 info-user" data-toggle="modal" data-target="#largeModal" data-id="<?php echo $dados["ID"]?>" data-email="<?php echo $dados["email"]?>" data-login="<?php echo $dados["login"]?>"> Mais Informações</button>
                    </td>
                    </div>
                    </tr>
                  <?php
            ...
            <form action="edit-user.php" method="POST">
                ...
                <div class="modal-body">
                    <div class="card-body card-block">
						...
						<div class="form-group">
                            <label for="depto" class=" form-control-label">Departamento</label>
                            <select name="selectDepto" id="depto" class="form-control">
                                <option value="ADM">ADM</option>
                                <option value="COMUM">COMUM</option>
