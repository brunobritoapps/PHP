...
<head>
    ...
    <title>GOLDEN VITRINE | MANUTENÇÃO</title>
        ...
        <div class="breadcrumbs">
            <div class="col-sm-10">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Reserva de Manutenção || <?php echo  $string; ?></h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                        <div class="card-body card-block">
                            <form action="create-manut.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col-12 col-md-9"><textarea rows="8" placeholder="" class="form-control" id="res_obs" name="res_obs" ></textarea>
							</div>
							<br>
                            <hr>
                        ...
                        <div class="col-md-6">
                        <button type="submit" id="incluir" name="incluir" class="btn btn-warning">Reservar Manutenção</button>
