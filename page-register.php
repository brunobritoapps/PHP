...
if(isset($_POST['cadastrar']))
{
    ...
    $logarray = $array['login'];
        ...
        if($logarray == $login){
            ...
            $insert = mysqli_query($db,"insert into usuarios(login,senha,email,perfil,status) values('$login','$senha','$email','$perfil','$status')");
...
<head>
    ...
    <title>GOLDEN VITRINE | REGISTRO DE USUARIO</title>
