...
if(isset($_POST['incluir']))
{
            ...
            $res_embarca='RETORNO VAZIO';
	//		$res_destina=$_POST['res_destina'];
			$res_tpcarga='RETORNO VAZIO';
		...
		$insertS = mysqli_query($db,"UPDATE ROTAS SET RES_STATUS = 'R' WHERE FRE_FRETE = '$res_numrese'");        
          echo"<scriptSql RELATORIO PERFORMANCE language='javascript' type='text/javascript'>alert('Retorno vazio solicitado com sucesso!');window.location.href='rotas.php'</scriptSql RELATORIO PERFORMANCE>";
           }else{
           echo mysqli_error($db);
		   echo"<scriptSql RELATORIO PERFORMANCE language='javascript' type='text/javascript'>alert('Ocorreu um erro ao solicitar o retorno vazio.');window.location.href='rotas.php'</scriptSql RELATORIO PERFORMANCE>";
          }
        }
